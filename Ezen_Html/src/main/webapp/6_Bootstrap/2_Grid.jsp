...
<body>
	<%@ include file="1_BootstrapStart.jsp" %> <!-- 부트스트랩 CSS, JS -->
	<h1> 박스모델 : container </h1>
	<h1> 그리드 </h1>
	<ul>
		<li> 768px 이하 : .col-xs- </li>
		<li> 768px 이하 : .col-sm- </li>
	...
	<h3> offset 위치 잡기[offset-2 : 2칸 띄우기] </h3>
		<div class="container">
			<div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5"> .col-md-5 </div>
				<div class="col-md-8"> .col-md-8 </div> <!-- 12이상이 되면 다음칸 아래로 내려감 -->
			</div>
			<div class="row">
				<div class="col-md-4"> .col-md-4 </div>
				<div class="col-md-7"> .col-md-7 </div> <!-- 한줄로 내려감 -->
			</div>
		</div>
</body>
</html>