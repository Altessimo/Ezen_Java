...
<body>
	...
	<ul id="productul">
		...
		<li class="row2"> 프리미엄 파인애플 바구니 세트... </li>
		<li class="row3"> 25,000원 </li>
		<li class="row4"> 판매자가 직접 키운 파인애플 입니다.<br>
		집들이, 기념일, 병문안 생일 등 특별한 날에 상큼한 파인애플과 함께... </li>
		<li class="row5"> 리뷰 <span>130</span> · 평점 <span>4.9</span> </li>
		<!-- alt + 오른쪽 키보드 1 8 3(Num Lock 확인) or ㄱ + 찾기 -->
	</ul>
</body>
</html>