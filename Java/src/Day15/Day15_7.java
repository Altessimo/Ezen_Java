...
public class Day15_7 {
	...
	/*
	 * 이진 트리 : 하나의 노드 기준으로 왼쪽, 오른쪽 자식 노드 가짐
	 * 	부모노드 기준으로 낮은 값은 왼쪽, 큰 값은 오른쪽
	 */
		// 트리명.frist() : 가장 왼쪽 노드[가장 작은 값]
		// 트리명..last() : 가장 오른쪽 노드[가장 큰 값]
	...
	public static void main(String[] args) {
		...
		System.out.println("93점 이거나 바로 아래 점수 : " + scores.floor(93)); // floor는 이거나
