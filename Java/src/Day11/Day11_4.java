...
public class Day11_4 {
	...
	// 키보드로부터 문자열 받아오는 원리
		...
		// 키보드 입력 → 입력[바이트] → 바이트 → 문자열 변환
		
	// String 클래스
		// 1. String 생성자 : 바이트열 를 문자열 저장
...
// P.498
		...
		// 입출력 관련 해서는 항상 예외처리 발생
		// System.in.read(저장할 변수명=배열명) : 키보드로부터 읽어온 바이트를 배열에 저장
...
// P. 502
		...
		String str = "안녕하세요"; // 한긇은 1개당 2바이트, 영문 1개당 1바이트
...
// P.506
		// 8. replace("교채할문자열", "새로운 문자열") : 문자열 대치
		String oldsr = "자바는 객체 지향 언어 입니다. 자바는 풍부한 API를 지원합니다";
		String newstr = oldsr.replace("자바", "Java");
...
// P.507
		...
		System.out.println(ssn2.substring(7)); // 시작 인덱스 ~
...
// P.510
		...
		String str6 = String.valueOf(10.5); // 정수형 [double] → 문자열 "10.5"
