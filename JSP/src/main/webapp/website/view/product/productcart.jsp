	...
	<div class="container">
		...
		<table class="table">
			...
			<% 
				...
				totalprice += cart.getP_count()*product.getP_price(); // 카트 내 제품 누적 합계[제품 수량 * 제품 가격]
			%>
			<tr>
				...
				<td width="15%" class="aline-middle" id="total<%=i %>"><%=decimalFormat.format(cart.getP_count()*product.getP_price()) %>원</td>
			...
			<div class="text-center totalbox">
				...
				= 총 주문금액 : <span class="carttotal"><%=decimalFormat.format(totalprice+3000) %></span></p>
			</div>
			
			<div class= "row">
				<div class= "col-md-3 offset-3"><!-- 3칸 띄우기 -->
