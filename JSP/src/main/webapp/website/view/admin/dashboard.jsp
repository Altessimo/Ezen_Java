...
<body>
	...
	<%
		...
		ArrayList<Product> products = ProductDao.getProductDao().getProductslist(key, keyword);
	%>
	<div class="container">
		
		<form action="dashboard.jsp" method="get" class="col-md-5 offset-3 input-group my-3"> <!-- 검색 -->
			<select class="custam-select col-md-3" name="key">
		...
		<table class="table">
			...
			<tr>
				...
				<td>
					<a href="#"><button class="btn-outline-info"> 수정 </button></a>
